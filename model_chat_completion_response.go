...
func (o *ChatCompletionResponse) GetUsage() TokenUsage {
...
// and a boolean to check if the value has been set.
func (o *ChatCompletionResponse) GetUsageOk() (*TokenUsage, bool) {
	if o == nil || IsNil(o.Usage) {
		return nil, false
	}
	return o.Usage, true
...
func (o *ChatCompletionResponse) SetUsage(v TokenUsage) {
	o.Usage = &v
}
