...
func newBilling(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Billing {
	return &Billing{
		rootSDK:          rootSDK,
...
func (s *Billing) GatewayBillingLog(ctx context.Context, request operations.GatewayBillingLogRequestBody, opts ...operations.Option) (*operations.GatewayBillingLogResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/gateway/billing/log")
	if err != nil {
	...
	res := &operations.GatewayBillingLogResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GatewayBillingLogResponseBody
